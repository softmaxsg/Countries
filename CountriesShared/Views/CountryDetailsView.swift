...
public final class CountryDetailsView: UIView {
    ...
    public var isAdvancedDetailsVisible: Bool {
        get { return !(advancedDetailsWrapper?.isHidden ?? false) }
        set { advancedDetailsWrapper?.isHidden = !newValue }
    }
    
    public func configure(with details: CountryDetailsViewModelProtocol) {

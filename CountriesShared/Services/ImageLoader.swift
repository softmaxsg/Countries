...
public final class ImageLoader: ImageLoaderProtocol {
    ...
    public init(urlSession: URLSessionProtocol = URLSession.shared, cache: NSCache<NSURL, UIImage> = NSCache<NSURL, UIImage>()) {
...
extension ImageLoaderProtocol {
    ...
    @discardableResult
    public func setImage(with url: URL, on imageView: UIImageView, placeholder: UIImage?) -> Cancellable {
    ...
    public func cancel(task: Cancellable, on imageView: UIImageView) {
